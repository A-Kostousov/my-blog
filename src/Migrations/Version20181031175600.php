...
final class Version20181031175600 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, content_id INT NOT NULL, author VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_5F9E962A84A0A3ED (content_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
